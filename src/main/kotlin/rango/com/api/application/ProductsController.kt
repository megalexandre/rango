...
class ProductsController(
    ...
    @PostMapping
    fun saveProducts(@RequestBody request: ProductCreateRequest) =
        ResponseEntity.created(URI.create("/products"))
            .body(productService.save(request.toEntity()).toResponse())
